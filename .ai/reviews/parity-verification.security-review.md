---
title: 'Security Review: Gameweave Drop-in Acceptance Gate'
...
# Security Review: Gameweave Drop-in Acceptance Gate
...
- **Files reviewed:** 4 (`__tests__/gameweave-parity.test.ts`, `examples/gameweave.config.json`, `README.md`, `knip.json`)
...
- `examples/gameweave.config.json` contains no secrets — only service names, env-var names, and URL templates.
