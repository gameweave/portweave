...
None directly — conceptually mirrors how Gameweave's worktree-env
application (modeled on Gameweave's internal worktree-port system) could be
called in-process rather than via a wrapper child. Gameweave never built
this; Portweave does.
