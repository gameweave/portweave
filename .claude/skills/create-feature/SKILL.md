...
4. **Prior art** — relevant existing patterns or prior tools that inform the shape
...
3. Identify any prior art or existing patterns that inspire the shape, and cite
   them without proposing concrete implementation details.
