...
4. Identify relevant prior art and existing patterns (in the repo under `src/`,
   or noted in [.ai/DESIGN.md](../../../.ai/DESIGN.md)) and cite them.
...
- Approach should reference existing Portweave code under `src/` by path:line
  when applicable.
