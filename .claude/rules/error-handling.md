...
Portweave uses a `Result`/throw error-handling contract suited to a single-package context. Error codes use the `PW` prefix when we eventually need a diagnostic namespace.
