...
| Path                                      | Why ignored                                                                                                                                                                                                                                                                                                                |
| ----------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `scripts/src/tasks/**`                    | Session-based task-management subsystem dropped in from boardflip. No production callers in `src/`; surface lives entirely in `scripts/`. Knip's static analysis sees no entry path.                                                                                                                                       |
